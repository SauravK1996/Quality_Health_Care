...
%>
	<nav class="navbar navbar-expand-sm navbar-dark bg-primary py-2 fixed-top">
    	<div class="container">
	      <a href="/doctor"><img src="https://i.ibb.co/qy17PCj/qmc-logo.png" alt="qhc-logo" ></a>
	      ...
	      <div class="collapse navbar-collapse" id="navbarCollapse">
	       <ul class="navbar-nav ml-auto">
	         ...
	         <li class="nav-item">
	           <a href="/doctor" class="nav-link active">Home</a>
	         </li>
	         <li class="nav-item">
...
<div class="d-flex mt-5" style="height: 100%">
  <div class="list-group w-25 h-100 bg-secondary">
    <form action="/doctor/action" method="post" class="mt-5 w-75 ml-4" >
