...
<jsp:include page="ReporterHeaderAndSidebar.jsp" /> 
	...
	<%ArrayList<DoctorBean> availableDoctors = (ArrayList<DoctorBean>)request.getAttribute("availableDoctors");%>
	...
	<table class="table">
		...
		<tbody>
			<%for(DoctorBean dBean : availableDoctors){ %>
				<tr>
			...
			<%}}else{%>
				<h4 class="text-primary mt-5 ml-4">No doctors are available on selected date. 
				Please choose another date.</h4>
			<%} %>
		</tbody>
	</table>
	</div>
